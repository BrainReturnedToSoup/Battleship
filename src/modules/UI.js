...
class UIConstructor {
  ...
  #buildFragment() {
    ...
    mainContainerElement.appendChild(pauseToggleButtonElement);
    mainContainerElement.appendChild(newGameButtonElement);
  ...
  #fragmentPortionBuilders = {
    mainContainer: () => {
      ...
      const range = document.createRange(),
        ...
        mainContainerElement = frag.firstChild;
    ...
    pauseToggle: () => {
      ...
      const range = document.createRange(),
        ...
        pauseToggleButtonElement = frag.firstChild;
    ...
    newGame: () => {
      ...
      const range = document.createRange(),
        ...
        newGameButtonElement = frag.firstChild;
